         ...
         dbc.Col(width=12, lg=4, xl=3, className="mb-4 mb-lg-0", children=[
             dbc.Card(className="shadow-sm",children=[
                 ...
                 dbc.CardBody([
                     ...
                     dbc.Button("Build Model", id='build-model-button', n_clicks=0, color="secondary", className="w-100 fw-bold", style={'backgroundColor': colors['secondary'], 'borderColor': colors['secondary'], 'color': colors['text']}, disabled=True),
        ...
        dbc.Row(class_name="mb-3", children=[
            dbc.Col(width=12, children=[
                ...
                dbc.Alert(
                    ...
                    dismissable=False, is_open=True, className="small p-2",
        ...
        dbc.Container(fluid=True, id="page-content", className="flex-grow-1 overflow-auto py-4 px-lg-3 px-md-2 px-1", children=[
            dbc.Tabs(id="main-tabs", active_tab="tab-explore", children=[
                dbc.Tab(label="Data Exploration", tab_id="tab-explore", children=[
                    html.Div(create_data_exploration_tab(), className="pt-4")
                ]),
                dbc.Tab(label="Model Building", tab_id="tab-model", children=[
                    html.Div(create_model_building_tab(), className="pt-4")
                ]),
            ]),
        ]),
