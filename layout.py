...
def create_cohort_definition_interface():
    return dbc.Card(className="mb-4 shadow-sm", children=[
        ...
        dbc.CardBody(style={'padding': '0.75rem'}, children=[
            dbc.Accordion([
                dbc.AccordionItem([
                    html.Div([
...
def create_data_exploration_tab():
    return dbc.Row([
         dbc.Col(width=12, lg=4, xl=3, className="mb-4 mb-lg-0", children=[
             ...
             html.Div(id='dataset-details-links-container', className="mt-3 shadow-sm"),
         ]),
         dbc.Col(width=12, lg=8, xl=9, children=[
             ...
             html.Div(id='column-metadata-display-container', className="mb-3"),
             html.Hr(className="my-3"),
             dbc.Card(className="shadow-sm",children=[
...
def create_model_building_tab():
     return dbc.Row([
         ...
         dbc.Col(width=12, lg=8, xl=9, children=[
             html.Div(id='model-equation-container', className="mb-3"),
             dbc.Card(className="mb-3 shadow-sm", children=[
...
def create_layout():
        ...
        dbc.Row(class_name="mb-3", children=[
            dbc.Col(width=12, children=[
                ...
                dbc.Alert(
                    ...
                    dismissable=False, is_open=True, className="small p-2 mb-0",
    ...
    navbar = dbc.Navbar(
        ...
        color="light",
        dark=False,
        className="border-bottom shadow-sm flex-shrink-0",
        sticky="top",
    ...
    layout = dbc.Container(fluid=True, className="d-flex flex-column vh-100 overflow-hidden", style={'backgroundColor': colors['light']}, children=[
        ...
        dbc.Offcanvas(
            ...
            title="Data Source & Cohorts",
            is_open=False, # CHANGED HERE
            placement="start",
            backdrop=False,
            scrollable=True,
            style={'width': '450px', 'borderRight': f'1px solid {colors["border"]}'}
        ),
        dbc.Container(fluid=True, id="page-content", className="flex-grow-1 overflow-auto py-3 px-lg-3 px-md-2 px-1", children=[
